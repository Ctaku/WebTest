...
if not(request.cookies(eChsys)("ManageKEY")="super" or request.cookies(eChsys)("ManageKEY")="typemaster" or request.cookies(eChsys)("ManageKEY")="bigmaster") then
	...
	if rs.EOF then
		Show_Err("非法ID，请确认OpinionID是否存在!<br><br>－－－<a href='javascript:history.back()'>回去重来</a>－－－")
		Response.End
	end if
	%>
<html><head>
...
<tr>
	<td width="100%" align=center bgcolor="#FFFFFF">
		...
		<p>
			<font color=red>
				删除发言：[ <font color="#000066"> <%=OpinionID%> </font>号 ]？<br><BR>
				（删除后将无法恢复！）
			</font>
		</p>
		<p></p>
