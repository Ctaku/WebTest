...
<tr> 
	<td align="center" colspan="4" width="100%"  height="34">
		程序名称：<select name="tool_file_name" >
	...
	%>
		...
		<input type="submit" name="Submit" value="运行" title="运行选择的工具程序" onMouseOver="window.status='运行选择的工具程序';return true;" onMouseOut="window.status='';return true;" >&nbsp;&nbsp;
	</td>
</tr>
<tr> 
	<td colspan="4" align="center" width="100%" height="25" bgcolor="#FFFFFF"></td>
