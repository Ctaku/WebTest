...
<input type="file" name="file1" size=26 class="an">
<input type="submit" name="Submit" value="上传" class="an"><br><br><hr color="#808080" width="270" size="1">
<font color="#808080">*** 广告图片仅支持Gif或Swf（Flash）两种格式 </font>
</td>
</tr>
</form>
</table>
