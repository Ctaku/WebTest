...
<title><%=copyright%><%=version%>&nbsp;<%=ver%> - 新手上路</title>
</head>
<body topmargin="0">
...
<div align="center">
  <table width="100%" border="0" cellspacing="1" cellpadding="3">
    <tr> 
      <td height="25"  bgcolor="#FE9956"><font color="#FFFFFF"><strong>使用说明：</strong></font></td>
    </tr>
    <tr> 
      <td bgcolor="#FFE6E6">1、如果出现了红色的“对不起，你没有执行该操作的权限！”的字样时，您可以重新登录试试！如果还出现这样的情况，说明您无权操作该部分功能！<br> 
        <br>
    ...
    <tr> 
      <td bgcolor="#FE9956"><strong><font color="#FFFFFF">你问我答：</font></strong></td>
    </tr>
    <tr>
      <td height="898" bgcolor="#FFE6E6"> 
        <p>你问我答： </p>
        <p>问：为什么我修改了超级管理员的用户名与密码后无法登录了啊?<br>
答：首次登录不能修改默认的前台发文普通用户的用户名，因超级管理员对应前台发文普通用户，登录时先用普通用户登录，再用超级用户进行管理登录。否则超级管理员无法登录。</p>
        <p><br>
