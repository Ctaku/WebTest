...
<%if mode=5 then%>
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F1F7FC">
  <tr>
    <td height="25">&nbsp;&nbsp;&nbsp;<img src="Images/arrow_dh_1.gif" width="7" height="7">&nbsp;&nbsp;&nbsp;<font class=m_tittle>&nbsp;</font>栏目导航&nbsp;&nbsp;<a href="./" class="daohang">网站首页</a>&gt;&gt;<%=E_typename%> </td>
  </tr>
  <tr>
...
<table width="80%" height="400" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr valign="top">
    <td width="200" height="400" rowspan="2" bgcolor="#F1F7FC"><div align="center">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr bordercolor="#999999">
          <td height="50" align="center" valign="middle" background="Images/type_dh.gif"><img src="Images/arrow_dh_1.gif" width="7" height="7"><font color="#ffffff" class="yellow_title">&nbsp;&nbsp;<%=E_typename%>·总栏 <%=E_typeorder%></font> </td>
        </tr>
        <tr>
          <td height="231" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
            <tr>
              <td align="center" valign="middle"><%  
                      ...
                      <table width="100%" border="0" cellpadding="3" cellspacing="0" id="AutoNumber2" style="border-collapse: collapse">
                        <tr>
                          <td height=22 colspan="2" align="center"><%if not Rs.eof then%>
                            <a class=middle href="E_BigClass.asp?E_typeid=<%=E_typeid%>&E_BigClassID=<%=Rs("E_BigClassID")%>"><font color="#000000"><%=Rs("E_BigClassName")%></font> </a> </td>
                        </tr>
                        <%set nRs=conn.execute("SELECT * FROM "& db_EC_SmallClass_Table &" where E_BigClassID="&cstr(rs("E_BigClassID"))&" order by smallclassorder")%>
                      </table>
                <%Rs.movenext   
												end if
												loop  
                ...
                <table width="100%" height="25" border="0" cellpadding="0" cellspacing="0" id="AutoNumber4" style="border-collapse: collapse">
                  <tr>
                    <td height="50" align=center background="Images/type_dh.gif"><span class="yellow_title"><img src="Images/arrow_dh_1.gif" width="7" height="7">&nbsp;&nbsp;</span><span class="yellow_title">最新图文</span></td>
                  </tr>
                  <tr>
  ...
  <td width="800" rowspan="2">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="25" background="Images/dh_bg.gif">&nbsp;&nbsp;&nbsp;<img src="Images/arrow_dh_1.gif" width="7" height="7">&nbsp;&nbsp;&nbsp;<font class=m_tittle>&nbsp;</font>栏目导航&nbsp;&nbsp;<a href="./" class="daohang">网站首页</a>&gt;&gt;<%=E_typename%>
		</td>
      </tr>
      <tr>
        <td>
		<% select case  E_typename%>
		<% case "十八大代表选举" %>		
			 <img src="images\18da.jpg" width="560" border="0" align="absright">
		<%end select%>
		<!--flah图片
		<div align="center">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="94%" height="25" background="Images/dh_bg.gif">&nbsp;&nbsp;&nbsp;<img src="Images/arrow_dh_1.gif" width="7" height="7">&nbsp;&nbsp;<%=E_typename%>·[本栏]</td>
        <td width="6%" background="Images/dh_bg.gif"><a class=class href='E_NobigClass.asp?E_typeid=<%=E_typeid%>'><img src="images/more.gif" border="0" alt="更多<%=E_typename%>"></a></td>
      </tr>
	</table>
                  ...
                  <tr>
					...
					<%if not rsnodigclass.EOF then%>
                        <div align="center">
                          <% content=htmlencode4(rsnodigclass("Content"))
					content=replace(content,"[---分页---]","")%>
                          <a class=middle href="E_ReadNews.asp?NewsID=<%=rsnodigclass("NewsID")%>" target=_blank title="<%=CutStr(nohtml(Content),150)%>...">
                          ...
                          <br>
                      <a class=middle href="E_ReadNews.asp?NewsID=<%=rsnodigclass("NewsID")%>" target=_blank title="<%=rsnodigclass("title")%>"><%=CutStr(rsnodigclass("title"),16)%></a> </div></td>
					...
					content=replace(content,"[---分页---]","")
					%>
                    <td width=25% align=center valign="top" style="table-layout:fixed; word-break:break-all"><%if not rsnodigclass.EOF then%>
                        <div align="center">
                          <%
					content=htmlencode4(rsnodigclass("Content"))
					content=replace(content,"[---分页---]","")%>
		...
		%>
		  <tr>
            <td><div align="center">
             <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
               <td width="76%">&nbsp;&nbsp;<img src="IMAGES/006.gif" width="10" height="10"> <%=img%> <a class=middle href="<%if rsnodigclass("titleface")="无" then %><%=newsurl%><% else %> <%=newswwwurl%><%end if%>" title="<%=rsnodigclass("title")%>" target="_blank"> <<%=rsnodigclass("titletype")%>><font color="<%=rsnodigclass("titlecolor")%>"> <%=CutStr(title,46)%></font></<%=rsnodigclass("titletype")%>></a>
                <!--标题后评论提示-->
            ...
            <div align="right">
              <%if showtime="1" then%>
                ...
                <%end if%>
              &nbsp; </div></td>
          <td width="16%" align="left"><div align="right">
            ...
            <td><div align="center">
                <table width="100%" border="0" cellpadding="3" cellspacing="0">
                  <tr bgcolor="#EFEFEF">
                    ...
                    <td width="18%" align="right" bgcolor="#EFEFEF">
                      <div align="right">
                        <%if showtime="1" then%>
                          <%=datetime%>
                          <%end if%>
                  ...
                  <tr>
                    <td width="38%"><a class=middle href="<%if rsnodigclass("titleface")="无" then %><%=newsurl%><% else %> <%=newswwwurl%><%end if%>" target=_blank title="<%=htmlencode4(rsnodigclass("title"))%>">
                      <%if   rsnodigclass("picname")=("")   then%>
        ...
        <table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber5">
          ...
          <%set rs3=server.CreateObject("ADODB.RecordSet")
				if uselevel=1 then
					...
					%>
          <tr>
            <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="3" align="center">
                <!--图片换行显示1-->
                <% if not rs3.EOF then %>
				...
				%>
                  <td width=25% align=center valign="top" style="table-layout:fixed; word-break:break-all"><%if not rs3.EOF then%>
                      <div align="center">
                        ...
                        <br>
                    <a class=middle href="E_ReadNews.asp?NewsID=<%=rs3("NewsID")%>" target=_blank title="<%=rs3("title")%>"><%=CutStr(rs3("title"),16)%></a> </div></td>
                  <%rs3.movenext   
				end if %>
                  <!--图片换行显示2-->
                  <td width=25% align=center valign="top" style="table-layout:fixed; word-break:break-all"><%if not rs3.EOF then%>
		...
		while not rs3.EOF
          ...
          <tr>
            <td colspan="2"><div align="center">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="76%">&nbsp;&nbsp;<img src="IMAGES/006.gif" width="10" height="10"> <%=img%> <a class=middle href="<%if rs3("titleface")="无" then %><%=newsurl%><% else %> <%=newswwwurl%><%end if%>" title="<%=rs3("title")%>" target="_blank"> <<%=rs3("titletype")%>><font color="<%=rs3("titlecolor")%>"> <%=CutStr(title,160)%></font></<%=rs3("titletype")%>></a>
                        <!--标题后评论提示-->
                    ...
                    <td width="19%" align="left">
                      <div align="right">
                        <%if showtime="1" then%>
                          ...
                          <%end if%>
                      &nbsp; </div></td>
                    <td width="15%" align="left"><div align="right">
                ...
                <table width="100%" border="0" cellpadding="3" cellspacing="0">
                  <tr bgcolor="#EFEFEF">
                    ...
                    <td width="17%" align="right" bgcolor="#EFEFEF"><%if showtime="1" then%>
                        ...
                        <%end if%>
                      &nbsp; </td>
                    <td width="15%" align="center"><div align="right">
                      <%if year(rs3("updatetime"))=year(date()) and month(rs3("updatetime"))=month(date()) and day(rs3("updatetime"))=day(date()) then%>
                      <img src="images/new.gif">
                      <%end if%>
                      <%if rs3("goodnews")="1" then%>
