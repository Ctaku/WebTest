...
<form align="center" method="post" name="FrmAddLink" LANGUAGE="javascript" onsubmit="return FrmAddLink_onsubmit()" action="<%if request.cookies(eChsys)("key")="super" then%>SaveUserReg.asp<%else%>SaveReg.asp<%end if%>">
<tr class="TDtop">
...
<tr>
	...
	<td height="32"> 
		<div align="left"> 
			<input name="webname" size="26" class="smallInput" maxlength="20"   title="这里请输入您的网站名称，最多为20个汉字">
		</div>
	</td>
</tr>
<tr>
	...
	<td height="32"> 
		<div align="left"> 
			<input name="weburl" size="26" class="smallInput" maxlength="100"  type="text"  value="http://" title="这里请输入您的网站地址，最多为50个字符，前面必须带http://">
		</div>
	</td>
</tr>
<tr>
	...
	<td height="32"> 
		<div align="left"> 
			<input name="logo" size="26" class="smallInput" maxlength="100"  type="text"  value="http://" title="这里请输入您的网站LOGO地址，最多为50个字符，如果您在第一选项选择的是文字链接，这项就不必填">
		</div>
	</td>
</tr>
<tr>
	...
	<td height="32"> 
		<div align="left"> 
			<input name="webmaster" size="26" class="smallInput" maxlength="20"  type="text"  title="这里请输入您的大名了，不然我知道您是谁啊。最多为20个字符">
		</div>
	</td>
</tr>
<tr> 
	...
	<td height="32"> 
		<div align="left"> 
			<input name="email" size="26" class="smallInput" maxlength="30"  type="text"  value="@" title="这里请输入您的联系电子邮件，最多为30个字符">
		</div>
	</td>
</tr>
<tr>
	...
	<td height="32" valign="middle"> 
		<textarea rows="5" name="content" cols="29"   title="这里请输入您的网站的简单介绍"></textarea>
	</td>
</tr>
<tr>
	<td colspan=2>
	<div align="center">
		<input type="hidden" name="pass" value="<%if request.cookies(eChsys)("key")="super" then%>1<%else%>0<%end if%>">
