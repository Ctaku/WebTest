...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="F1F7FC">
  <tr>
    <td width="100%" height="25" background="Images/dh_bg.gif" class="daohang" >&nbsp;&nbsp;&nbsp;<img src="Images/arrow_dh_1.gif" width="7" height="7">&nbsp;&nbsp;&nbsp;栏目导航&nbsp;&nbsp;<a class="daohang" href="./" >网站首页</a>&gt;&gt;<a href="E_GuestBook.asp" class="daohang">公众留言</a>&gt;&gt;查看留言</td>
  </tr>
							<tr>
								<td height="48" align="center" background="IMAGES/bookBG.gif"  class="white_link">
									<a href="guestadd.asp" class=top1>我要留言</a> | <a class=top1 href="javascript:window.location.reload()">刷新</a> </td>
							</tr>
<tr valign="top"> 
		<td>
									...
									<table width="98%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed; word-break:break-all;border-collapse: collapse">
										<tr>
											...
											<%if rs("passed")=1 then
												...
												<%if rs("reply")<>"" then %>
													<p>
													<font color="#FF0000"><b><img src="Images/m_reply.gif" width="20" height="20" align="absmiddle">&nbsp;站长回复：</b><br>
											  <%=rs("reply")%></font></p>
												<%end if%>
											</td>
										</tr>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr> 
		<td align="center" background="IMAGES/bookBG.gif" height="50" class="white_link">
			<span class="yellow_title"><a href="guestadd.asp" class="yellow_title">我要留言</a> | <a  class="yellow_title" href="javascript:window.location.reload()">刷新</a>	        </span>
