...
<title>博克作者：<%=keyword%>__在[<%=Request("action")%>]__搜索__<%=eChSys%></title>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<td width="200" height="84" valign="top" bgcolor="F1F7FC"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td background="Images/type_dh.gif" height="50" class="yellow_title"><center>
          新闻日历
        </center></td>
      </tr>
      <tr>
        <td><div align="center">
            <STYLE TYPE="text/css"> 
.today {font-weight:bold;BACKGROUND: #FF6600} 
.satday{color:green} 
.sunday{color:red} 
...
window.open ("Result.asp?keyword="+document.all.year.value+"-"+document.all.month.value+"-"+event.srcElement.innerText+"&action=UpdateTime") 
            ...
            <table id="calendar" border="0" cellpadding="3" cellspacing="0">
              <thead>
                <tr>
                  <TD COLSPAN=7 ALIGN=CENTER><SELECT name="select" ID="month" ONCHANGE="newCalendar()">
                      <SCRIPT LANGUAGE="JavaScript"> 
...
months[intLoop]); 
                      ...
                      <SELECT name="select" ID="year" ONCHANGE="newCalendar()">
                        <SCRIPT LANGUAGE="JavaScript"> 
...
document.write("</TR>"); 
	  ...
	  <td>
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				  <td background="Images/dh_bg.gif" height="25">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="daohang" href="./" >网站首页</a>&gt;&gt;搜索>>博克作者：<%=keyword%></td>
			  </tr>  
		  </table>
...
If Not rs.eof then
	...
	do until rs.Eof or i = rs.PageSize
	    ...
	    <%=CutStr(title,46)%>		</font></a> <font class=middle>(<%=rs("UpdateTime")%>)[<font color="#ff0000"><%=rs("click")%></font>]</font>								</td>
						  </tr>
		<%
		rs.MoveNext
		i = i + 1
