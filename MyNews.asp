...
if Request.cookies(eChsys)("key")="super" or Request.cookies(eChsys)("key")="check" or Request.cookies(eChsys)("KEY")="bigmaster" or Request.cookies(eChsys)("KEY")="smallmaster" or Request.cookies(eChsys)("KEY")="typemaster" or (Request.cookies(eChsys)("key")="selfreg" and jingyong=0) then
	if request.QueryString("action")="del" then
		conn.execute("delete from EC_News where newsid in ("&request.form("selectdel")&")")
...
<tr> 
<td colspan=8 class="title"  align="center" height=25 background="images/admin_topbg.gif"> 
	| 我的文章 |
</td>
</tr>
<tr>
...
<%set rs=server.CreateObject("ADODB.RecordSet")
rs.Source="select * from "& db_EC_News_Table &" where editor='" & CheckStr(request.cookies(eChsys)("UserName")) & "' order by NewsID desc"
