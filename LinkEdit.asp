...
<body topmargin="0">
		...
		dim sql
		dim rs
		sql="select * from "& db_EC_Link_Table &" where id="&ChkRequest(request("id"),1)
...
<tr>
	...
	<td width="55%" height="32"> 
		<select size="1" name="linktype" >
			...
			<option  <%if rs("linktype")="0" then%>selected<%end if%> value="0">首页文字链接</option>
			<option  <%if rs("linktype")="3" then%>selected<%end if%> value="3">其他文字链接</option>
		</select>
	</td>
</tr>
<tr> 
	...
	<td height="32"> 
		<div align="left">
			<input name="webname" size="26" class="smallInput" maxlength="20"  title="这里请输入您的网站名称，最多为20个汉字" value="<%=rs("webname")%>">
		</div>
	</td>
</tr>
<tr>
	...
	<td height="32"> 
		<div align="left"> 
			<input name="weburl" size="26" class="smallInput" maxlength="100" type="text" value="<%=rs("weburl")%>" title="这里请输入您的网站地址，最多为50个字符，前面必须带http://">
		</div>
	</td>
</tr>
<tr>
	...
	<td height="32"> 
		<div align="left"> 
			<input name="logo" size="26" class="smallInput" maxlength="100" type="text"  value="<%=rs("logo")%>" title="这里请输入您的网站LOGO地址，最多为50个字符，如果您在第一选项选择的是文字链接，这项就不必填">
		</div>
	</td>
</tr>
<tr>
	...
	<td height="32"> 
		<div align="left"> 
			<input name="webmaster" size="26" class="smallInput" maxlength="20" type="text"  title="这里请输入您的大名了，不然我知道您是谁啊。最多为20个字符" value="<%=rs("webmaster")%>">
		</div>
	</td>
</tr>
<tr> 
	...
	<td height="32"> 
		<div align="left"> 
			<input name="email" size="26" class="smallInput" maxlength="30" type="text"  value="<%=rs("email")%>" title="这里请输入您的联系电子邮件，最多为30个字符">
		</div>
	</td>
</tr>
<tr>
	...
	<td height="32" valign="middle"> 
		<textarea rows="5" name="content" cols="29"  title="这里请输入您的网站的简单介绍"><%=rs("content")%></textarea>
	</td>
</tr>
<tr>
	<td colspan=2 width="100%" height="25"></td>
