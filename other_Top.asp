...
<table width="80%" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF" >
  <tr>
    <td height="60"><a href="<%=OtherTopBannerurl%>">
        <%if gd2="1" then%>
        <img src="<%=OtherTopBanner%>" width="780" border="0" align="absmiddle">
        <%else%>
...
<table width="80%" height="30" border="0" align="center" cellpadding="0" cellspacing="0">
 <tr>
   <td width="90%" height="30" align="left"  valign="middle" background="images/top_dh_bg.gif" bgcolor="#ffffff" class="TOP1"><%
						dim mymenu
						mymenu=echuangmenu
