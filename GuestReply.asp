    ...
    <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="100%" height="25" background="Images/dh_bg.gif" >&nbsp;&nbsp;&nbsp;<img src="Images/arrow_dh_1.gif" width="7" height="7">&nbsp;&nbsp;<span class="white_link">&nbsp;</span><span class="daohang">栏目导航&nbsp;&nbsp;<a class=daohang href="./" >网站首页</a>&gt;&gt;<a href="E_GuestBook.asp" class="daohang">公众留言</a>&gt;&gt;回复留言</span></td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
          <td height="25" align="center"><input type="hidden" name="guestreply" value="">
