...
<%
IF not(request.cookies(eChsys)("KEY")="super" or request.cookies(eChsys)("KEY")="check") THEN
...
set rs=server.CreateObject("ADODB.RecordSet")
rs.Source="select * from "& db_EC_Review_Table &" order by NewsID desc"
...
<%if (delreview="1" and request.cookies(eChsys)("key")="input") or (shdelreview="1" and request.cookies(eChsys)("key")="check") or request.cookies(eChsys)("key")="super" then%>
...
url="DelReView1.asp?E_BigClassName=" & Request("E_BigClassName") & "&"
end if									
