...
if reviewid="" then
	...
	if not IsNumeric(reviewid) then
		...
		if request.cookies(eChsys)("key")="super" then
			...
			if not rs.eof then
				if request.cookies(eChsys)("username")=rs("author") or aaas=1 then
					dim qqhflag
					qqhflag=rs("NewsID")
					%>
<html>
<head>
<title>编辑留言__<%=eChSys%></title>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F1F7FC">
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="100%" height="25" background="Images/dh_bg.gif">&nbsp;&nbsp;&nbsp;<img src="Images/arrow_dh_1.gif" width="7" height="7">&nbsp;&nbsp;&nbsp;<span class="daohang">栏目导航&nbsp;&nbsp;<a class=daohang href="./" >网站首页</a>&gt;&gt;<a href="E_GuestBook.asp" class="daohang">公众留言</a>&gt;&gt;编辑留言</span></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
  ...
  <tr valign="top">
    <td><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td><div align="center">
          ...
          <table cellpadding=3 cellspacing=1 border=0 width=95%>
            <tr>
              <td width="14%" height="22" align="right"> 用户名：</td>
              <td width="86%" height="22"><input type="text" name="guestname" maxlength="10" size="10" style="font-family: 宋体; font-size: 9pt;" value="<%=rs("author")%>">
              </td>
            </tr>
            <tr>
              <td width="14%" height="22" align="right"> 密码：</td>
              <td width="86%" height="22"><input type="password" name="password" maxlength="10" size="10" style="font-family: 宋体; font-size: 9pt;">
                如果您是本站注册会员，请输入您的密码 </td>
            </tr>
            <tr>
              <td width="14%" height="22" align="right"><font color="#FF0000">*</font>&nbsp;验证码：</td>
              <td width="86%" height="22"><%
						...
						rndnum=rndnum&num1
						loop
						session("verifycode9")=rndnum
						%>
                      <input type="text" name="verifycode9" size="8" font face="宋体" style="font-size: 9pt">
                      <b><span style="background-color: #ffffff"><font color=#000000><%=session("verifycode9")%></font></span> </td>
            </tr>
            <tr>
              <td width="14%" align="right" height="22">&nbsp;身份：</td>
              <td width="86%" height="22"><font color="#FF0000">
            ...
            <tr>
              <td width="14%" height="22" align="right">&nbsp;来自：</td>
              <td width="86%" height="22"><input type="text" name="editor" maxlength="10" size="10" style="font-family: 宋体; font-size: 9pt;" value="<%=rs("from")%>">
              </td>
            </tr>
            <tr>
              <td width="14%" height="22" align="right">&nbsp;e-mail地址：</td>
              <td width="86%" height="22"><input type="text" name="email" style="font-family: 宋体; font-size: 9pt;" size="20" value="<%=rs("email")%>">
                如果留空，默认为您注册时使用的E-mail地址。</td>
            </tr>
            <tr>
              <td width="14%" height="22" align="right">&nbsp;主页地址：</td>
              <td width="86%" height="22"><input type="text" name="homepage" style="font-family: 宋体; font-size: 9pt;" size="20" value="<%=rs("homepage")%>">
              </td>
            </tr>
            <tr>
              <td width="14%" height="22" align="right">&nbsp;oicq：</td>
              <td width="86%" height="22"><input type="text" name="oicq" maxlength="10" style="font-family: 宋体; font-size: 9pt;" size="20" value="<%=rs("oicq")%>">
              </td>
            </tr>
            <tr>
              <td width="14%" align="right" height="22" valign="top">&nbsp;<br>
                留言内容：</td>
              <td width="86%" height="22"><br>
      ...
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
          <td height="25" align="center">以上内容仅写给管理员（悄悄话）：&nbsp;&nbsp;
              <%if qqhflag=-1 then%>
              <input type="radio" name="qqh" checked value=-1>
            是&nbsp;&nbsp;
              <input type="radio" name="qqh" value=0>
            否
            <%else%>
              <input type="radio" name="qqh" value=-1>
            是&nbsp;&nbsp;
              <input type="radio" name="qqh" checked value=0>
            否
            <%end if%>
              <br>
              <br>
        ...
        <tr>
          <td height="25" align="center"><input name="button" type="button" onClick="javascript:history.go(-1)" value=" 返 回 ">
            &nbsp;&nbsp;
            <input type="submit" value=" 修 改 " name="Submit3" OnClick="document.form1.content.value = frames.message.document.body.innerHTML;">
            &nbsp;
