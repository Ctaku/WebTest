...
sub upload_0()    '使用化境无组件上传类
	...
	for each formName in upload.file '列出所有上传了的文件
        ...
        set f=nothing
			...
			set rs=nothing
			msg="上传文件成功！"
			strJS=strJS & "parent.document.system.moveurl.value='"& filename &"';"
		end if
		strJS=strJS & "alert('" & msg & "');" & vbcrlf
		strJS=strJS & "window.location = 'UploadMove.htm';" & vbcrlf
		strJS=strJS & "</script>"
