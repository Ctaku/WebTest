...
<form method="POST" action="E_BoardSave.asp" OnSubmit="return checkdata()" onReset="return ResetForm();" name="form1">
<tr class="TDtop">
...
<tr> 
	...
	<td width="685" bgcolor="#FFFFFF">&nbsp;
		<input name="title" id=me type="TEXT" size=60 onMouseOver="window.status='在这里输入要添加的公告标题，必填';return true;" onMouseOut="window.status='';return true;" title='在这里输入要添加的公告标题，必填' >
	</td>
</tr>
<tr> 
	...
	<img class=None onMouseDown="Check(this,2)" onMouseOver="Check(this,1)" onMouseOut="Check(this,0)" onMouseUp="Check(this,1)" src="images/link.gif" align="absmiddle" border="0" alt="超级链接" onClick="FormatText('createLink')" style="cursor: hand;">
		...
		<script language="javascript">
			document.write ('<iframe src="E_BoardTextBox.asp?action=new" id="message" width="650" height="300" align=center></iframe>')
