              ...
              <tr>
                <td valign="top">
                  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                    <tr bgcolor="CDCCCC">
                      <td width="100%" height="25" background="Images/dh_bg.gif" bgcolor="CDCCCC" class="white_link">&nbsp;&nbsp;&nbsp;<img src="Images/arrow_dh_1.gif" width="7" height="7">&nbsp;&nbsp;&nbsp;<span class="daohang">栏目导航&nbsp;&nbsp;<a class=daohang href="./" >网站首页</a>&gt;&gt;<a href="E_GuestBook.asp" class="daohang">公众留言</a>&gt;&gt;书写留言</span></td>
                    </tr>
                    <tr bgcolor="CDCCCC">
                      <td height="48" align="center" background="IMAGES/BookBG.gif" bgcolor="#FFFFFF"><font color="#000000">发表留言(有<font color="#FF0000">*</font>号的必填)</font></td>
                    </tr>
                </table></td>
              </tr>
          </table></td>
                ...
                <td><div align="center">
                    <table width=95% border=0 cellpadding=3 cellspacing=1>
                      <tr>
                        ...
                        <td width="70%" height="22">
                          <input type="text" name="guestname" maxlength="10" size="10" style="font-family: 宋体; font-size: 9pt;" <%if request.cookies(eChsys)("username")<>"" then%>value="<%=request.cookies(eChsys)("username")%>" readonly<%end if%>>
                        </td>
                      </tr>
                      <tr>
                        <td width="15%" height="22" align="right"> <font color="#FF0000">*</font>&nbsp;验证码：</td>
                        <td width="70%" height="22">
                          <%
						dim num1,rndnum
						Randomize
						...
						%>
                          ...
                          <b><span style="background-color: #ffffff"><font color=#000000><%=session("verifycode9")%></font></span> </b></td>
                      </tr>
                      <tr>
                    ...
                    如果您是本站注册会员，请输入您的密码</td>
                      ...
                      <tr>
                        ...
                        <td width="70%" height="22">
                          <input type="text" name="editor" maxlength="10" size="10" style="font-family: 宋体; font-size: 9pt;">
                        </td>
                      </tr>
                      <tr>
                    ...
                    如果留空，默认为您注册时使用的E-mail地址。</td>
                      ...
                      <tr>
                        ...
                        <td width="70%" height="22">
                          <input type="text" name="oicq" maxlength="10" style="font-family: 宋体; font-size: 9pt;" size="20" value="<%=oicq%>">
                        </td>
                      </tr>
                      <tr>
...
&nbsp;头像：</td>
                        <td width="70%" height="39"> <br>
                            <% for i=1 to 7 %>
                            <img src="images/image<%=i%>.GIF" align="absmiddle" width="45" height="45">
                            <input type="radio" name="face" value='images/Image<%=i%>.gif'>
                            <%next%>
                            <br>
                            <br>
                            <% for i=8 to 14 %>
