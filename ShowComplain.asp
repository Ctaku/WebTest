...
<div align="center">
<form action=E_ReplyComplainSave.asp method=post name=form1 OnSubmit="return checkdata()" onReset="return ResetForm();">	
  <table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="<%=border%>">
    ...
    <tr>
      <td height="24"><div align="right"><strong><span class="STYLE4">*</span>是否公开：</strong></div></td>
      <td><%if rs("ClassID")=0 then%><font color=red>不公开</font><%else%><font color=red>可公开</font><%end if%></td>
    </tr>
    <tr>
...
<iframe style="top:2px" ID="UploadFiles" src="Uploadfile1.htm" frameborder=0 scrolling=no width="420" height="40"></iframe>
		...
		document.write ('<iframe src="E_ReplyComplainBox.asp?action=new" id="message" width="420" height="200" align=left></iframe>')
    ...
    <tr>
      ...
      <input type="hidden" name="ComplainID" value="<%=cint(request("ComplainID"))%>">	
