...
set rs=server.CreateObject("ADODB.RecordSet")
sql1="select * from "& db_EC_LeadMail_Table &" where topic like '%"&keyword&"%'  order by LeadMailID DESC"
 ...
 <tr valign="top">
   <td width="100%" valign="top">
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="TDtop1">
                <tr>
                  <td width="100%" height="25" align="center" class="TDtop"> <B>信件搜索结果</B> </td>
                </tr>
              </table>
...
·<a  class=middle href='ShowLeadMail.asp?LeadMailID=<%=rs("LeadMailID")%>'><%=htmlencode(DisplayTopic)%>...</a></td>
	...
	<%
	url="Admin_LeadMail_Result.asp?keyword=" & keyword
...
set rs=nothing
%>
<a href="E_leadMailList.asp">返回</a>
</td>
</tr>			
</table>
