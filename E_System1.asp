...
<tr> 
          <td colspan="3"  width="100%" height=25 align="center"  class="TDtop"> 
            | 网站功能设置 |</td>
        </tr>
        <tr bgcolor="#FFFFFF"> 
          <td width="25%"  align="right">启用页面信息版权保护：</td>
          <td  colspan="2" align="left"><select name="topbg" size="1" >
              <option <%if rs9("topbg")<>"0" then%>selected<%end if%> value="1">启用</option>
              <option <%if rs9("topbg")="0" then%>selected<%end if%> value="0">禁用</option>
            </select>&nbsp;<font color=red>即:鼠标右键功能</font></td>
        </tr>
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >启用栏目导航：</td>
          <td  colspan="2" align="left" > <select name="t_bg" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="uselevel" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="usecheck" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="modnewsable" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="zs" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="zs1" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="zs2" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="reviewable" size="1" >
		...
		<tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="M_MAIN" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="showip" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="reviewcheck" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="reviewcheckshow" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="linkreg" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="linkpass" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="checkshow" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >首页是否稿件排行榜：</td>
          <td  colspan="2" align="left" > <select name="showuser" size="1" >
		  ...
		  <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >首页是否自动播放视频点播：</td>
          <td  colspan="2" align="left" > <select name="showmove" size="1" >
              <option <%if rs9("showmove")="1" then%>selected<%end if%> value="1">自动播放</option>
              <option <%if rs9("showmove")="0" then%>selected<%end if%> value="0">不自动播放</option>
            </select></td>
        </tr>
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >首页是否显示专题文章：</td>
          <td  colspan="2" align="left" > <select name="showspecial" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="showdata" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="showsearch" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="search" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="showauthor" size="1" >
        ...
        <tr bgcolor="#FFFFFF">
          ...
          <td  colspan="2" align="left"><select name="topfont" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="showvote" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="showlink" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="showlinkmap" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="showclub" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="showcount" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="showtime" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="showyear" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="showclick" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select size="1" name="freetime" >
              <%for i=0 to 30%>
        ...
        <%if request.cookies(eChsys)("ManageKEY")="super" and request.cookies(eChsys)("ManagePurview")="99999" then%>
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >系统管理员 网站属性权限设置：</td>
          <td  colspan="2" align="left" > <select name="system" size="1" >
            ...
            点击“<a title=系统管理员系统设置功能详细说明 onMouseOver="window.status='系统管理员系统设置功能详细说明';return true;" onMouseOut="window.status='';return true;" href=javascript:alert("当系统管理员系统设置功能设置为启用时，系统管理员能进行系统设置，但该选项及以下13列不包括在内；当系统管理员系统设置功能设置为屏蔽时，系统管理员不能进行设置。")>这里</a>”查看详细说明。 
          </td>
        </tr>
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >系统管理员 CSS模版编辑功能：</td>
          <td  colspan="2" align="left" > <select name="css" size="1" >
              <option <%if rs9("css")="1" then%>selected<%end if%> value="1">启用</option>
              <option <%if rs9("css")="0" then%>selected<%end if%> value="0">屏蔽</option>
            </select> </td>
        </tr>
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >系统管理员 系统初始化功能：</td>
          <td  colspan="2" align="left" > <select name="init" size="1" >
              <option <%if rs9("init")="1" then%>selected<%end if%> value="1">启用</option>
              <option <%if rs9("init")="0" then%>selected<%end if%> value="0">屏蔽</option>
            </select> </td>
        </tr>
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >系统管理员 功能设置 权限设置：</td>
          <td  colspan="2" align="left" > <select name="powermana" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >系统管理员 投票管理功能：</td>
          <td  colspan="2" align="left" > <select name="votemana" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >系统管理员 友情链接管理：</td>
          <td  colspan="2" align="left" > <select name="linkmana" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >系统管理员 部门管理：</td>
          <td  colspan="2" align="left" > <select name="depmanage" size="1" >
              <option <%if rs9("depmanage")="1" then%>selected<%end if%> value="1">启用</option>
              <option <%if rs9("depmanage")="0" then%>selected<%end if%> value="0">屏蔽</option>
            </select> </td>
        </tr>
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >系统管理员 公告管理：</td>
          <td  colspan="2" align="left" > <select name="ggmanage" size="1" >
              <option <%if rs9("ggmanage")="1" then%>selected<%end if%> value="1">启用</option>
              <option <%if rs9("ggmanage")="0" then%>selected<%end if%> value="0">屏蔽</option>
            </select> </td>
        </tr>
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >系统管理员 留言管理：</td>
          <td  colspan="2" align="left" > <select name="lymanage" size="1" >
              <option <%if rs9("lymanage")="1" then%>selected<%end if%> value="1">启用</option>
              <option <%if rs9("lymanage")="0" then%>selected<%end if%> value="0">屏蔽</option>
            </select> </td>
        </tr>
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >系统管理员 评论管理：</td>
          <td  colspan="2" align="left" > <select name="plmanage" size="1" >
              <option <%if rs9("plmanage")="1" then%>selected<%end if%> value="1">启用</option>
              <option <%if rs9("plmanage")="0" then%>selected<%end if%> value="0">屏蔽</option>
            </select> </td>
        </tr>
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >系统管理员 局长信箱管理：</td>
          <td  colspan="2" align="left" > <select name="mailmanage" size="1" >
              <option <%if rs9("mailmanage")="1" then%>selected<%end if%> value="1">启用</option>
              <option <%if rs9("mailmanage")="0" then%>selected<%end if%> value="0">屏蔽</option>
            </select> </td>
        </tr>
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >系统管理员 举报投诉管理：</td>
          <td  colspan="2" align="left" > <select name="complainmanage" size="1" >
              <option <%if rs9("complainmanage")="1" then%>selected<%end if%> value="1">启用</option>
              <option <%if rs9("complainmanage")="0" then%>selected<%end if%> value="0">屏蔽</option>
            </select> </td>
        </tr>
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >系统管理员 建言献策管理：</td>
          <td  colspan="2" align="left" > <select name="opininomanage" size="1" >
              <option <%if rs9("opininomanage")="1" then%>selected<%end if%> value="1">启用</option>
              <option <%if rs9("opininomanage")="0" then%>selected<%end if%> value="0">屏蔽</option>
            </select> </td>
        </tr>
        <%end if%>
        <tr bgcolor="#FFFFFF"> 
          <td width="25%" align="right" >文章审核员管理小类选项：</td>
          <td  colspan="2" align="left" > <select name="shsmallgl" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="shspecialgl" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="shdelreview" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="checkmod" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="checkdel" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="smallgl" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="specialgl" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="delreview" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="inputmodpwd" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="smallmana" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="reg" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="fabiao" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="fabiaocheck" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          ...
          <td  colspan="2" align="left" > <select name="fabiaomod" size="1" >
        ...
        <tr bgcolor="#FFFFFF"> 
          <td colspan="3"  width="611"> <div align="center"> 
              <%if rs9("powermana")="1" and request.cookies(eChsys)("ManagePurview")<>"99999" then%>
