...
<table width="1002" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF" >
  <tr>
    <td height="60"><a href="http://10.124.80.168">
        <%if gd2="1" then%>
        <img src="<%=TopBanner%>" width="1002" border="0" align="absmiddle">
        <%else%>
...
<table width="1002" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr >
	   <td >
	     <a href = "http://10.124.0.13/E_Type.asp?E_typeid=23"> <img src="images\18da.jpg" width="1002" height="200" border="0" align="absmiddle">
	   </td>
	</tr>
</table>